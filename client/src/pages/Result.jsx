...
const Result = () => {
  ...
  return (
    // <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75h]'>
    <div className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden'>
              ...
              {//if I am having no resultImage and having the image then produce loading effect
        ...
        {resultImage && <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
          <button onClick={() => navigate('/')} className='cursor-pointer px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full hover:scale-105 transition-all duration-700'>Try another image</button>
          {/* to download image href given */}
