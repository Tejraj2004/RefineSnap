...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
        {/* Title */}
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'>Remove Background With <br/> High Quality and Accuracy</h1>

        <div className='relative w-full max-w-3xl overflow-hidden m-auto mt-10 rounded-xl'>
            {/* background Image */}
